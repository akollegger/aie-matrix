...
- **FR-006**: The quizmaster MUST evaluate answers against the withheld rubric after all questions are answered, using exact-match comparison (case-insensitive for `short_answer`, case-sensitive for `multiple_choice` option identifiers).
