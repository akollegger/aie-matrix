...
import { buildSocialEchoAgentCard } from "./buildSocialAgentCard.js";
import { getEchoTckState, SocialEchoExecutor } from "./executor.js";
...
const agentCard = buildSocialEchoAgentCard(publicBase);
const requestHandler = new DefaultRequestHandler(
  agentCard,
  new InMemoryTaskStore(),
  new SocialEchoExecutor(),
);
...
app.get("/_tck/echo", requireToken, (_req, res) => {
  res.status(200).json(getEchoTckState());
});
