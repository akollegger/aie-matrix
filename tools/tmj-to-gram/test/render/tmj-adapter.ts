...
/**
 * Full TMJ layout merge: polygon interior colors first, then explicit layout cells (overrides).
 * Matches the committed gram semantics (compression is “absence of cell node”, not TMJ erasure).
 */
