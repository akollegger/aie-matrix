...
## Recent Changes
- 029-funder-into-npc: Added TypeScript 5.7 / Node.js 24 (ESM, `"type": "module"`) + `effect` v3+, `@a2a-js/sdk` 0.3.13+, `@aie-matrix/ghost-ts-client` (workspace), `@relateby/pattern` ^0.4.2
